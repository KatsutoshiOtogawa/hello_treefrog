...
public:
    ...
    static Blog create(const QString &id, const QString &title, const QString &body);
    static Blog create(const QVariantMap &values);
    static Blog get(const QString &id);
    static Blog get(const QString &id, int lockRevision);
    static int count();
