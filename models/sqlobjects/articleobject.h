#ifndef ARTICLEOBJECT_H
#define ARTICLEOBJECT_H

#include <TSqlObject>
#include <QSharedData>


class T_MODEL_EXPORT ArticleObject : public TSqlObject, public QSharedData
{
public:
    QString id;
    QString title;
    ...
    QString tableName() const override { return QStringLiteral("article"); }
